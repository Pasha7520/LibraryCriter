...
public class StatisticUtil {
	...
	public void printTimeStartUseLibrary3(Customer customer) throws SQLException{
		...
		Period period = daoCustomerImpl.getDuringCustomerUseLibrary(customer);
		...
		if(period.getYears()>0){
			System.out.println("Customer use the librari during "+period.getDays()+" day!! and "+period.getMonths()+" months and "+period.getYears()+" years!");
		}
		else if(period.getMonths()>0){
			System.out.println("Customer use the librari during "+period.getDays()+" day!! and "+period.getMonths()+" months !");
		}
		else{
		System.out.println("Customer use the librari during "+period.getDays()+" day!!");
